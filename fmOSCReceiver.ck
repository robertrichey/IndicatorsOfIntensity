...
while (true) {
    ...
    while (oin.recv(msg) != 0) { 
        ...
        getTransformation(0.0, 392, 200, 800, msg.getInt(0)) => float watts;
        getTransformation(0.0, 83.6, 0.1, 1, msg.getFloat(1)) => float kph;
        getTransformation(114.0, 154, 0, 1000, msg.getInt(2)) => float hr;
